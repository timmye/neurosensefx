...
var _CTraderCommand_clientMsgId, _CTraderCommand_responsePromise, _CTraderCommand_response, _CTraderCommand_settled, _CTraderCommand_resolve, _CTraderCommand_reject;
...
class CTraderCommand {
    constructor({ clientMsgId, }) {
        ...
        _CTraderCommand_settled.set(this, void 0);
        ...
        __classPrivateFieldSet(this, _CTraderCommand_settled, false, "f");
    ...
    resolve(response) {
        var _a;
        if (__classPrivateFieldGet(this, _CTraderCommand_settled, "f")) {
            return;
        }
        __classPrivateFieldSet(this, _CTraderCommand_settled, true, "f");
...
_CTraderCommand_clientMsgId = new WeakMap(), _CTraderCommand_responsePromise = new WeakMap(), _CTraderCommand_response = new WeakMap(), _CTraderCommand_settled = new WeakMap(), _CTraderCommand_resolve = new WeakMap(), _CTraderCommand_reject = new WeakMap();

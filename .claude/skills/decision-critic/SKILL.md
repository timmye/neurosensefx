...
<invoke working-dir=".claude/skills/scripts" cmd="sh -c 'PYTHONPATH=. python3 -m skills.decision_critic.decision_critic --step 1 --total-steps 7 --decision '<decision text>'" />

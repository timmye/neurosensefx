...
<invoke working-dir=".claude/skills/scripts" cmd="sh -c 'PYTHONPATH=. python3 -m skills.prompt_engineer.optimize --step 1" />

Then continue with determined scope:

<invoke working-dir=".claude/skills/scripts" cmd="sh -c 'PYTHONPATH=. python3 -m skills.prompt_engineer.optimize --step 2 --scope <scope>" />

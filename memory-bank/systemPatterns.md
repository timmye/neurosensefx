...
### 1. Three-Server Pattern (Frontend/Backend/BrowserTools Separation)
**Purpose**: Separate concerns between UI, data processing, and browser analysis
...
const browserToolsServer = npx('@agentdeskai/browser-tools-server@latest');
```

**Benefits**:
- Independent scaling of frontend, backend, and browser tools
- Clear separation of UI, data, and debugging concerns
- Flexible deployment options for development workflows
- Enhanced development efficiency with integrated browser analysis
- Foolproof always-available browser debugging capabilities
...
### 3. BrowserTools Server Patterns
- **MCP Tool Integration**: Provide browser analysis capabilities to Cline
- **Health Monitoring**: Automatic server health checks and status reporting
- **Service Management**: Integrated startup/shutdown with main application
- **Log Management**: Dedicated logging for browser analysis activities
- **Chrome Extension Communication**: WebSocket-based communication with browser extension

These system patterns provide the architectural foundation for NeuroSense FX's three-server architecture, ensuring performance, maintainability, and scalability with enhanced development capabilities.

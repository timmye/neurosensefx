...
| `xAxisCustom.js` | Custom calendar-aware x-axis via registerXAxis — span-tier matrix with boundary-first placement, adaptive fill intervals, and context-aware label formatting | Modifying x-axis behavior, adjusting tick density, changing label formats |

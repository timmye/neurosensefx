    ...
    try {
      await page.waitForFunction(
        () => {
          ...
          const indicators = [
            document.querySelector('canvas'),            // Look for any canvas element
            ...
            document.querySelector('#app'),               // Check if app is rendered
            document.querySelector('div')                 // Any div element indicates app is loaded
          ];
      ...
      // Don't throw error, just continue - we can still test canvas positioning
    }
  }
